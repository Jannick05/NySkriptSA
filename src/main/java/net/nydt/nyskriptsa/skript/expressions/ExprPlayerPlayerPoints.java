...
public class ExprPlayerPlayerPoints extends SimplePropertyExpression<OfflinePlayer, Integer> {

    static {
        register(ExprPlayerPlayerPoints.class, Integer.class, "player points", "offlineplayer");
    }
    ...
    public Integer convert(OfflinePlayer player) {
        ...
        return (user != null) ? user.getPlayerPoints() : 0;
    }
